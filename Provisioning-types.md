...
- **Icon** - Icon for the space type that appears on the 'Select template' step, you can change this if you wish. By default Provision Assist uses the official Microsoft logos. **Please ensure that the image you link to will be accessible to all users that will use the app**
