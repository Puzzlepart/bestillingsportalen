# Bestillingsportalen Version 2

<img src="./images/V2HomeDesktop.png" height="500" alt="Bestillingsportalen V2 Home Screen Desktop Screenshot"><br/>

<img src="./images/V2RecommendationMobile.jpeg" height="500" alt="Bestillingsportalen V2 Home Screen Mobile Screenshot"><br/>

We are excited to announce the release of Bestillingsportalen V2 🥳
...
The new Power App is named 'Bestillingsportalen (V2)', feel free to rename this to suit your needs.
...
See the [Bestillingsportalen Roadmap](https://github.com/orgs/pnp/projects/5) for more details on enhancements to the V2 app. 
...
**Description**: Primary accent colour (HEX format) for the Bestillingsportalen app. Set this to the main brand colour for your organization.
...
**Description**: Secondary accent colour (HEX format) for the Bestillingsportalen app. Set this to a colour from your organizations brand palette.
...
4. Follow 'Step 5' onwards in the main [Deployment guide](./Deployment-guide.md) to complete deployment of the Power Platform components. **When configuring the app ensure you edit and configure the 'Bestillingsportalen V2' app.**
5. Share the V2 Power App with Users/Admins and optionally add to Microsoft Teams.

## Feedback and Issues

This is the first release of the new Bestillingsportalen app and we expect there to be teething issues and odd pesky 🪲. Please report any issues by raising an [issue](https://github.com/Puzzlepart/bestillingsportalen/issues/new/choose) so that we can address these.

## Extra Screenshots

<img src="./images/V2HomeMobile.jpeg" height="500" alt="Bestillingsportalen V2 Home Screen Mobile Screenshot"><br/>

<img src="./images/V2RequestDesktop.png" height="500" alt="Bestillingsportalen V2 New Request Desktop Screenshot"><br/>
