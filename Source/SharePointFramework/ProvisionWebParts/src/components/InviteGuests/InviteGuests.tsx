...
export const InviteGuests: React.FC<IInviteGuestsProps> = (props) => {
  const {
    ...
    presetSpGroupName,
    showSpActionNone,
    showSpActionAddToExisting,
    showSpActionCreateNew,
    showSpActionPreset,
    spGroupActionOrder,
...
InviteGuests.defaultProps = {
  ...
  defaultSpGroupAction: 'None',
  defaultSpGroupName: '',
  presetSpGroupName: '',
  showSpActionNone: true,
  showSpActionAddToExisting: true,
  showSpActionCreateNew: true,
  showSpActionPreset: true,
  spGroupActionOrder: '',
