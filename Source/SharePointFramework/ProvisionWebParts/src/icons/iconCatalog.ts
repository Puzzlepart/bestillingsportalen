...
export const iconCatalog: Record<string, IIconBundle> = {
  ...
  TextBulletList: {
    regular: TextBulletListRegular,
    filled: TextBulletListFilled
  },
  ChevronLeft: {
  ...
  FormNew: {
    regular: FormNewRegular,
    filled: FormNewFilled
  },
  BoxMultiple: {
  ...
  PeopleAudience: {
    regular: PeopleAudienceRegular,
    filled: PeopleAudienceFilled
  },
  MultiselectLtr: {
