...
Write-Host "  3. Configure the approval process, then activate and share the flows as the service account (steps 4-6 in the guide - interactive by design, cannot be automated)." -ForegroundColor Cyan
