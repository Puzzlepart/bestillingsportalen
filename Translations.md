...
## Overview
The Bestillingsportalen Power App supports multiple languages, so that users can interact with the app in the default language of their browser or MS Teams client. The app currently supports English and Dutch, but it can be easily extended to include more languages.
...
```{Language: "en-US"; Labels: { lblWelcome: "Welcome to the Bestillingsportalen"; btnCancel: "Cancel"; btnBack: "Back"; btnNext: "Next"; btnSubmit: "Submit";  ... }}```
...
This formula returns the value of the Welcome key in the JSON object that corresponds to the Language variable. If the Language variable is "en", the formula returns "Welcome to the Bestillingsportalen App". If the Language variable is "nl", the formula returns "Welkom bij de Bestillingsportalen App".
...
```{Language: "fr-FR"; Labels: { lblWelcome: "Bienvenue dans Bestillingsportalen"; btnCancel: "Annuler"; btnBack: "Retourner"; btnNext: "Ensuite"; btnSubmit: "Soumettre";  ... }}```

For your convinience, full formula from the OnReset action is saved in the file TranslationsBestillingsportalen.json under Source/Power Apps. You can use it to prepare the translations before pasting it into the  OnReset action of the component of the app.
